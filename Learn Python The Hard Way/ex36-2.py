...
"""
Here exit function is imported from sys module/library.
This exit function will end the program at certain point with exit(0) (zero)
function. here zero is used so that it ends the program without any error.
"""
...
In this function their is no argument
but there are print statement which prints
the strings, boolean variables which help us to
move ahead on this level, while loop is used to loop
until the condition becomes False. Inside while loop
their is a raw_input function which help us to get input
from user. if/elif/else statement is used to compare conditions.
Their is a short story of two characters, mysterious boy 
'Ichabod Crane' and a girl 'Grace Abigail' short for 'Abbhi',
The character 'Ichabod' has some special powers such as
he gets vibes by touching anything and he can control
minds also.
"""
...
In this function one argument is used i.e. why
it is also used in the print statement, a string characters
are used and exit function with 0 (zero) code is used.
"""
...
their is a raw_input function which help us to get input
from user. if/elif/else statement is used to compare conditions.
In this level, there are few things that might hurt 'Ichabod's'
heart.
"""
...
their is a raw_input function which help us to get input
from user. if/elif/else statement is used to compare conditions.
In this level, no person is their to challenge but a evil book
which contains poison and character 'Ichabod' has to open it if
he wants to cross this level.
"""
...
their is a raw_input function which help us to get input
from user. if/elif/else statement is used to compare conditions.
In this level, evil spirit is their in the face of Abbhi to
stop 'Ichabod'. Now its a great challenge for our character
to move ahead.
"""
...
their is a raw_input function which help us to get input
from user. if/elif/else statement is used to compare conditions.
In this level, aliens are there which means he can't use his power
in front of them because they are vey much power.
"""
...
their is a raw_input function which help us to get input
from user. if/elif/else statement is used to compare conditions.
In this level, again Ichabod has to think how to cross this
challenging level since mummies are dead. And again Ichabod
...
their is a raw_input function which help us to get input
from user. if/elif/else statement is used to compare conditions.
In this level, Ichabod can use his mind control powers but
he has to control 12 lions at the same time.
"""
...
their is a raw_input function which help us to get input
from user. if/elif/else statement is used to compare conditions.
This is the last level, where he finally get Abbhi.
"""
